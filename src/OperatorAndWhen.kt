fun main() {
    ...
    // melakukan perulangan apabila kondisi input terpenuhi dan do akan dimulai terlebih dahulu sebelum masuk kedalam kondisi yang telah ditentukan
    do {
        print("""
    ...
    """.trimIndent()) // Raw String membuat beberapa string tanpa penggabungan
        ...
        // Pengunaan when untuk meringkas percabangan pada if else
        when (input) {
            "1" -> {
            ...
            else -> { println("Maaf inputan yang anda masukan tidak ada, silahkan coba lagi..") } // else akan berjalan apabila semua kondisi tidak terpenuhi
        }
